...
IQ-TREE selected the TVM+F+G4 as the best-fit model, with a log likelihood of -8422347.559685886. There was 100% bootstrap support for all edges except for the edge representing the split into the *P. fuscus*, *P.f. vespertinus*, *P. syriacus*, and *P. balcanicus* lineage (Figure 1). The results of the BEAST analysis indicate high posterior probabilities (0.9938-1) for all nodes (Figure 2).

Both the maximum likelihood tree geenrated using IQ-TREE (Figure 1), and the maximum-clade credibilty tree generated using TreeAnnotator (Figure 2) show the six species of toads grouped as sister taxa as follows: *P. fuscus* & *P.f. vespertinus*, *P. syriacus* & *P. balcanicus*, and *P. cultripes* & *P. varaldii*. Note that in figure 2, *Pelobates cultripes* is duplicated because of an error in labeling the taxa using starBEAST – these two nodes can be collapsed into one. 

The two trees also support a split between the lineage of the two sister taxa, *P. cultripes* & *P. varaldii*, and the two other groups of sister taxa: *P. fuscus*, *P.f. vespertinus*, *P. syriacus*, and *P. balcanicus*
...
Figure 2. Maximum-clade credibility tree generated using TreeAnnotator and visualized using FigTree. Bayesian posterior probabilities are shown on the branches. Note that *Pelobates cultripes* is duplicated because of an error in labeling the taxa using starBEAST – these two nodes can be collapsed into one.


## Discussion 

These results indicate the presense of 3 sets of sister species in the *Pelobates* genus. 

Although the analyses in Dufresnes et al 2019 relied on the complete dataset, and the authors further differntatied several species into more subspecies and/or groups (i.e., *P. balcanicus* into *P. balcanicus* South, *P. balcanicus* East, *P. balcanicus* West, and *P. balcanicus chloeae*, my results using only 13 samples were very similar, which gives sme more confidence in the analyses I performed. Namely, the split between the lineage of the two sister taxa, *P. cultripes* & *P. varaldii*, and the two other groups of sister taxa was the same. Additionally, Dufresnes et al 2019 found support for the grouping of the sister species using PCAs.

It is also interesting that using such a small dataset comapred to the full dataset (~7% of the full datadset), yielded results very close to the complete dataset, at least in terms of trees. This is important to consider when analyzing pilot dataset when only a small sample size is feasible. Lastly, the results between IQ-TREE and BEAST were quite similar. While Dufresnes et al 2019 only used BEAST for their analyses, it would be interesting to examine how the results from IQ-TREE will differ, if any, when using the complete dataset.
